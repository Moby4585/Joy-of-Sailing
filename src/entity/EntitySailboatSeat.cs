...
namespace sailboat
{
    public class EntitySailboatSeat : IMountable
    {
        public EntitySailboat EntityBoat;
        ...
        public EntitySailboatSeat(EntitySailboat entityBoat, int seatNumber, Vec3f mountOffset)
        {
        ...
        {
            Entity entityBoat = world.GetEntityById(tree.GetLong("entityIdSailboat"));
            if (entityBoat is EntitySailboat eBoat)
            {
        ...
        {
            tree.SetString("className", "sailboat");
            tree.SetLong("entityIdSailboat", this.EntityBoat.EntityId);
